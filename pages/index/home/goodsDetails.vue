	...
	<view>
		...
		<view class="banners">
			...
			<swiper class="swiper" indicator-dots="true" indicator-color="#8A8989" circular="true" indicator-active-color="#FF8C19">
				<swiper-item v-for="(b,b_idx) in bannerList" :key="b_idx">
		...
		<view class="goodsDesc">
			<view class="gd-name">
				苹果水果新鲜当季带箱10斤批应季脆甜陕西红富士丑苹果咯啦整箱
			</view>
			<view class="gd-price">
				￥159.00
			</view>
		...
		<view class="eachMs">
			...
			<view class="choseMs">
				<view class="cm-item" :class="[current_c === c_idx ? 'cm-active' : '']" @tap="choseEach(c_idx)" v-for="(c,c_idx) in choseList" :key="c_idx">
					{{c.name}}
				</view>
			</view>
		</view>
		...
		<view class="btmHandle">
			<view class="bh-left">
				<view class="bl-item" @click="myTools.navTo('index/home/store')">
					<view class="bi-icon">
			...
			<view class="bh-right">
				<view class="br-btns">
					<view class="bb-left" @tap="openChoses(false)">
						加入购物车
					</view>
					<view class="bb-right" @tap="openChoses(false)">
						立即购买
					</view>
				</view>
			</view>
		...
		<uni-popup ref="choseKindsA" type="bottom" :custom="true">
			<view class="choseA">
				...
				<view class="cb-btns" v-else @click="myTools.navTo('index/buyingVegetables/confirmOrderNormal')">
					确定
				</view>
			</view>
		</uni-popup>
